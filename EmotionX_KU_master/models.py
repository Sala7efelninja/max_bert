...
class EmotionX_Model(nn.Module):
    ...
    def _define_weighted_cross_entropy_loss(self):
        ...
        weights = [sum(self.hparams.n_appear) / n for n in self.hparams.n_appear] #5 1 0 3 6
    ...
    '''
        sep_pos = self._get_sep_pos(batch_dialogs)  # return list with index of sep position in dialogue
